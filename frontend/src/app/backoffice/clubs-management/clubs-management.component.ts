  ...
  clubs: Club[] = [
    {
      ...
      leader: 'John Smith',
      status: 'active',
      image: placeholderImage(100, 100, 'WD'),
    ...
    },
    {
      ...
      status: 'active',
      image: placeholderImage(100, 100, 'DS'),
    ...
    },
    {
      ...
      leader: 'Emily Wilson',
      status: 'active',
      image: placeholderImage(100, 100, 'UX'),
    ...
    },
    {
      ...
      leader: 'Mike Davis',
      status: 'pending',
      image: placeholderImage(100, 100, 'MD'),
    ...
    },
    {
      ...
      leader: 'David Brown',
      status: 'active',
      image: placeholderImage(100, 100, 'CS'),
    ...
    },
    {
      ...
      status: 'inactive',
      image: placeholderImage(100, 100, 'GD'),
