  ...
  onSignIn() {
    ...
    this.authService.signin(this.signInData).subscribe({
      ...
      error: (err) => {
        ...
        this.signinError = msg && String(msg).trim() ? String(msg) : 'Identifiants incorrects ou compte bloqué. Vérifiez que le serveur (gateway + user microservice) est démarré.';
      }
    });
  }
